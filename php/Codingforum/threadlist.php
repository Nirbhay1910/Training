...
if($method=='POST')
{
  ...
  $sql = "INSERT INTO threads (thread_title,thread_desc,thread_cat_id,thread_user_id) VALUES ('$th_title','$th_desc','$th_id','$user_id')";
...
$sql = "SELECT category_id, category_name, category_description FROM category WHERE category_id='$id'";
...
<div class="container">
  ...
  <img class="mr-3" src="https://source.unsplash.com/100x100/?coding" alt="Generic placeholder image">
